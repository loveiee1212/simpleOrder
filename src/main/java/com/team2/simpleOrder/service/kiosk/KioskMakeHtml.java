	...
	// 판매키에 올라가 있는 상품리스트 Html만드는 메소드
	 public HashMap<String, Object> makeSellProListHtml(List<HashMap<String, Object>> skcList,
			...
			for (int i = 0; i < sellProList.size(); i++) {
				if (i == 0) {
					sb.append("<div id='detail_body'><div class='pList_detail'><div class='pd_imgName'>");
					...
					sb.append("<div class='pd_price'>가격 <font>" + sellProList.get(i).getPd_price()
							+ "</font>원</div></div></div></div>");
				} else {
