...
public class MailManger {
	...
	private String mesageMake(long cCodes) {
		...
		mesage.append("http://localhost:8081/simpleOrder/rest/emailAcountStatusChange/" + cCode + "</br>");
		mesage.append("<img src='https://chart.googleapis.com/chart?cht=qr&amp;chs=200x200&amp;chl=http://localhost:8081/simpleOrder/rest/emailAcountStatusChange/"+cCode+" ' style ='float = left'></br>");
