	...
	<div id="baseBox">
		<div id="baseinnerBox">
			<div id="calendar">
				...
				<button id="Exit" onclick="location.href='cList'">나가기</button>
			</div>
		</div>
	</div>
</body>
	...
	function getMonthDetail() {
		 ...
		 $.ajax({
			...
			success : function(data) {
				...
				var tr = "";
				tr += "<tr class='pro'><th colspan='5'>결제상품</th>";
				for (var product of data.productList){
					tr += "'<tr class='pro'><td>"+product.C_CODE+"</td>'";
					tr += "'<td>"+product.PD_NAME+"</td>'";
				...
				tr="";
				tr += "<tr class='pro'><th colspan='5'>반품상품</th>";
				for (var refund of data.refundList){
					tr += "'<tr class='pro'><td>"+refund.C_CODE+"</td>'";
					tr += "'<td>"+refund.PD_NAME+"</td>'";
